...
def maximo_basico(a: float, b: float) -> float:
    # Toma dos números y devuelve el mayor, sin utilizar la funcion max
    if a > b:
        return a
    elif a == b:
...
# NO MODIFICAR - INICIO
assert maximo_basico(10, 5) == 10  # assert es
...
def maximo_libreria(a: float, b: float) -> float:
    # Re-escribir utilizando el built-in max. Referencia: https://docs.python.org/3/library/functions.html#max
    return max(a, b)
    pass  # Completar
